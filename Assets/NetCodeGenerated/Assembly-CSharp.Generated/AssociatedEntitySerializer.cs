...
{
    [BurstCompile]
    public struct AssociatedEntityGhostComponentSerializer
    {
        static AssociatedEntityGhostComponentSerializer()
        {
            State = new GhostComponentSerializer.State
            {
                GhostFieldsHash = 14767913548786401661,
                ExcludeFromComponentCollectionHash = 0,
                ComponentType = ComponentType.ReadWrite<AssociatedEntity>(),
                ComponentSize = UnsafeUtility.SizeOf<AssociatedEntity>(),
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<AssociatedEntity>(componentData, componentStride*i);
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<AssociatedEntity>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<AssociatedEntity>(backupData, 0);
