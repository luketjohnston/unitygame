...
{
    [BurstCompile]
    public struct GamePositionGhostComponentSerializer
    {
        static GamePositionGhostComponentSerializer()
        {
            State = new GhostComponentSerializer.State
            {
                GhostFieldsHash = 9459521731408859100,
                ExcludeFromComponentCollectionHash = 0,
                ComponentType = ComponentType.ReadWrite<GamePosition>(),
                ComponentSize = UnsafeUtility.SizeOf<GamePosition>(),
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<GamePosition>(componentData, componentStride*i);
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<GamePosition>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<GamePosition>(backupData, 0);
