...
{
    [BurstCompile]
    public struct GameOrientationGhostComponentSerializer
    {
        static GameOrientationGhostComponentSerializer()
        {
            State = new GhostComponentSerializer.State
            {
                GhostFieldsHash = 9459521731408859100,
                ExcludeFromComponentCollectionHash = 0,
                ComponentType = ComponentType.ReadWrite<GameOrientation>(),
                ComponentSize = UnsafeUtility.SizeOf<GameOrientation>(),
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<GameOrientation>(componentData, componentStride*i);
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<GameOrientation>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<GameOrientation>(backupData, 0);
