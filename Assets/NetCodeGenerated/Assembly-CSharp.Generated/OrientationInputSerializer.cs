...
{
    [BurstCompile]
    public struct OrientationInputGhostComponentSerializer
    {
        static OrientationInputGhostComponentSerializer()
        {
            State = new GhostComponentSerializer.State
            {
                GhostFieldsHash = 9459521731408859100,
                ExcludeFromComponentCollectionHash = 0,
                ComponentType = ComponentType.ReadWrite<OrientationInput>(),
                ComponentSize = UnsafeUtility.SizeOf<OrientationInput>(),
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<OrientationInput>(componentData, componentStride*i);
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<OrientationInput>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<OrientationInput>(backupData, 0);
