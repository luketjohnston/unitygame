...
{
    [BurstCompile]
    public struct BackwardModifierGhostComponentSerializer
    {
        static BackwardModifierGhostComponentSerializer()
        {
            State = new GhostComponentSerializer.State
            {
                GhostFieldsHash = 3762052560045977970,
                ExcludeFromComponentCollectionHash = 0,
                ComponentType = ComponentType.ReadWrite<BackwardModifier>(),
                ComponentSize = UnsafeUtility.SizeOf<BackwardModifier>(),
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<BackwardModifier>(componentData, componentStride*i);
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<BackwardModifier>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<BackwardModifier>(backupData, 0);
