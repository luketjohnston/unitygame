...
{
    [BurstCompile]
    public struct FreezeTimerGhostComponentSerializer
    {
        static FreezeTimerGhostComponentSerializer()
        {
            State = new GhostComponentSerializer.State
            {
                GhostFieldsHash = 3762052560045977970,
                ExcludeFromComponentCollectionHash = 0,
                ComponentType = ComponentType.ReadWrite<FreezeTimer>(),
                ComponentSize = UnsafeUtility.SizeOf<FreezeTimer>(),
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<FreezeTimer>(componentData, componentStride*i);
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<FreezeTimer>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<FreezeTimer>(backupData, 0);
