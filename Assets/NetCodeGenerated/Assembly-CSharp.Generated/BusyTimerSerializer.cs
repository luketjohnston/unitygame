...
{
    [BurstCompile]
    public struct BusyTimerGhostComponentSerializer
    {
        static BusyTimerGhostComponentSerializer()
        {
            State = new GhostComponentSerializer.State
            {
                GhostFieldsHash = 3762052560045977970,
                ExcludeFromComponentCollectionHash = 0,
                ComponentType = ComponentType.ReadWrite<BusyTimer>(),
                ComponentSize = UnsafeUtility.SizeOf<BusyTimer>(),
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<BusyTimer>(componentData, componentStride*i);
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<BusyTimer>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<BusyTimer>(backupData, 0);
