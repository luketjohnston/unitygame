...
{
    [BurstCompile]
    public struct SpeedGhostComponentSerializer
    {
        static SpeedGhostComponentSerializer()
        {
            State = new GhostComponentSerializer.State
            {
                GhostFieldsHash = 3762052560045977970,
                ExcludeFromComponentCollectionHash = 0,
                ComponentType = ComponentType.ReadWrite<Speed>(),
                ComponentSize = UnsafeUtility.SizeOf<Speed>(),
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<Speed>(componentData, componentStride*i);
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<Speed>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<Speed>(backupData, 0);
