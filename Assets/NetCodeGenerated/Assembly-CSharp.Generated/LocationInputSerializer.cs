...
{
    [BurstCompile]
    public struct LocationInputGhostComponentSerializer
    {
        static LocationInputGhostComponentSerializer()
        {
            State = new GhostComponentSerializer.State
            {
                GhostFieldsHash = 9459521731408859100,
                ExcludeFromComponentCollectionHash = 0,
                ComponentType = ComponentType.ReadWrite<LocationInput>(),
                ComponentSize = UnsafeUtility.SizeOf<LocationInput>(),
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<LocationInput>(componentData, componentStride*i);
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<LocationInput>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<LocationInput>(backupData, 0);
