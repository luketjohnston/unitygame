...
{
    [BurstCompile]
    public struct RotatingGhostComponentSerializer
    {
        static RotatingGhostComponentSerializer()
        {
            State = new GhostComponentSerializer.State
            {
                GhostFieldsHash = 14767913548786401661,
                ExcludeFromComponentCollectionHash = 0,
                ComponentType = ComponentType.ReadWrite<Rotating>(),
                ComponentSize = UnsafeUtility.SizeOf<Rotating>(),
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<Rotating>(componentData, componentStride*i);
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<Rotating>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<Rotating>(backupData, 0);
