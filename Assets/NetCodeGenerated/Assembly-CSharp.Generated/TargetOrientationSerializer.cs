...
{
    [BurstCompile]
    public struct TargetOrientationGhostComponentSerializer
    {
        static TargetOrientationGhostComponentSerializer()
        {
            State = new GhostComponentSerializer.State
            {
                GhostFieldsHash = 9459521731408859100,
                ExcludeFromComponentCollectionHash = 0,
                ComponentType = ComponentType.ReadWrite<TargetOrientation>(),
                ComponentSize = UnsafeUtility.SizeOf<TargetOrientation>(),
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<TargetOrientation>(componentData, componentStride*i);
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<TargetOrientation>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<TargetOrientation>(backupData, 0);
