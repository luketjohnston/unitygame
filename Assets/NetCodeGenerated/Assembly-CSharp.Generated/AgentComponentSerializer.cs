...
{
    [BurstCompile]
    public struct AgentComponentGhostComponentSerializer
    {
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<AgentComponent>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<AgentComponent>(backupData, 0);
